        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system(system.sudo+" git clone https://github.com/Error-4-You/Tool-X.git "+system.home+"/Tool-X")
            ...
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system("git clone https://github.com/Error-4-You/Tool-X.git "+system.home+"/Tool-X")
            if os.path.exists(system.home+"/Tool-X/install.aex"):
